...
void analyzeMovies(const IMDB& imdb)
{
    ...
    // Otherwisie display all the actors in either of two movies
	...
	while(true){
		...
		cout<< "C -- to print all the common actors in both of the ovies. " <<endl;
		...
		set<string> same; // to score the union of actors_in_movie1 and actors_in_movie2
		same = imdb.find_actors_in_a_movie(matchedMovie1);
		set<string> actors_in_movie2  = imdb.find_actors_in_a_movie(matchedMovie2);
		...
		set<string> different; // to score the union of actors_in_movie1 and actors_in_movie2
